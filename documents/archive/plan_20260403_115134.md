...
- add split-aware upload transaction-unit classification in `src/ynab_il_importer/upload_prep.py`
- implement new split-transaction payload serialization on top of the current transaction-unit boundary
