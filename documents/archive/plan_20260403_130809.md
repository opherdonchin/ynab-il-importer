...
- decide whether the cross-budget builder should gain richer canonical nested snapshots before Step 3
- then do a real-data sanity run on the canonical review/output/upload path before touching Step 3
