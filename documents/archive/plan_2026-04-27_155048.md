...
1. Refresh and rebuild `pilates / 2026_04_14` with the restored Family-backed source:
   - `pixi run download-context-ynab -- pilates 2026_04_14`
   - `pixi run normalize-context -- pilates 2026_04_14`
   - `pixi run build-context-review -- pilates 2026_04_14`
   - `pixi run review-context -- pilates 2026_04_14`
2. Close `pilates / 2026_04_14` after review:
   - upload
   - bank sync/reconcile
   - card sync/cycle reconcile
3. Run the same active context workflow for `aikido / 2026_04_14` and close its `ynab_category` parity path.
