...
8. Finish the remaining active-path cleanup before Pilates normalization:
   - remove CSV sidecar assumptions from any still-live normalization or review helpers
   ...
   - convert or remove any remaining live pandas islands in [review_app/io.py](src/ynab_il_importer/review_app/io.py), [upload_prep.py](src/ynab_il_importer/upload_prep.py), and the active review-builder rule application path
