...
5. the remaining unresolved rows should now be a real review queue, not a builder regression

## Next Steps

1. Resume review from:
   - proposal: `data/paired/2026_04_01/family_proposed_transactions.parquet`
   - reviewed artifact: `data/paired/2026_04_01/family_proposed_transactions_reviewed_context_fixed.parquet`
2. Verify that the remaining `33` unresolved rows are genuine review work and not another pairing regression.
...
4. Add the next context workflow slice:
...
5. After review recovery is stable, continue simplifying review-app IO:
...
6. Continue shrinking remaining pandas islands where the code is already naturally columnar.
