...
1. Reopen `family / 2026_04_14` review on the rebuilt artifact and verify the payee-map defaults in grouped review:
   - `US Money -> Ready to Assign`
   - `Investments -> Investment income and expenses`
   - `Pilates Leumi -> Pilates`
