...
- Card reconciliation does not yet validate against the bank-side payment transfer amount.
...
- Add bank-payment validation for the finished-month cohort when the matching transfer exists in the bank account.
