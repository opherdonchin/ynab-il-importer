...
1. Reopen `family / 2026_04_14` review on the rebuilt artifact and verify the transfer review slice:
   ...
   - internal `Bank Leumi -> Opher x9922` transfer rows should no longer claim that a real category is required when both sides are on-budget, even in a session that previously had stale account metadata
