...
1. Rebuild `family / 2026_04_14`, review the newly surfaced carried-forward card rows, and upload them.
2. Finish Family April 14 closeout after that review/upload:
   - bank sync/reconcile
   - card sync/cycle reconcile
3. Run the same carryforward-aware review path for the remaining April 14 contexts as needed:
