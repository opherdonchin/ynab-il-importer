...
1. Reopen `family / 2026_04_14` review on the patched app and verify that off-budget transfer groups now show blank category defaults plus the category-required note.
