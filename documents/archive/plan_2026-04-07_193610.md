...
Resume the April 2 review from the corrected linked-source rebuild.
...
2. During the resumed review, watch the remaining ambiguous groups for cases where coarse fingerprints, especially BIT-style transfers, still hide meaningful distinctions.
3. Once the April 2 review is stable again, promote the corrected rebuilt/reconciled artifact set into `data/paired/2026_04_01/`.
