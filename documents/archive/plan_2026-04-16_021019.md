...
1. Implement the first transfer review slice:
   - derive transfer relations from the working review dataframe
   - expose transfer summaries in the review app
   - support relation-level decision and acceptance propagation back to member rows
   - cover at least one partial internal transfer case with focused tests
2. Reopen `family / 2026_04_14` review on the rebuilt artifact and verify the scoped account set and absence of internal transfer counterparts:
