...
6. keep split handling read-only in the app for now
   - display yes
   - editing deferred to Step 4
7. after the flat review model settles, update the longer-form split plan document to match the new Step 3 direction
