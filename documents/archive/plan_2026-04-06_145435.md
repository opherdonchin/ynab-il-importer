...
1. do one last quick live-app sanity pass on the refreshed demo/reviewed data before branch closeout:
   ...
   - confirm split summaries and modal category toggles read clearly in the UI and that `Show all categories` preserves in-progress split edits even after row additions/deletions
