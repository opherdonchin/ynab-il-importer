...
- Group-level payee override now uses a dropdown of known payees instead of free text.
...
- Review UI ergonomics under live use, now focused on remaining grouped-review bugs rather than basic save persistence.
